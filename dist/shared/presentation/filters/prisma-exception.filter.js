    ...
    constructor() {
        ...
        switch (exception.code) {
            case 'P2002':
                ...
                const field = (_a = exception.meta) === null || _a === void 0 ? void 0 : _a.target;
                message = `O valor do campo '${field === null || field === void 0 ? void 0 : field.join(', ')}' já existe`;
                break;
            case 'P2025':
        ...
        this.logger.error(`Prisma Error ${exception.code}: ${request.method} ${request.url} - ${JSON.stringify(errorResponse)}`);
